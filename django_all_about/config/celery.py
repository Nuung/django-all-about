...
from celery.signals import after_setup_logger, after_setup_task_logger # https://stackoverflow.com/questions/48289809/celery-logger-configuration
...
def setup_logger(
    sender=None, logger=None, loglevel=None, logfile=None, format=None, colorize=None, **kwargs
):
