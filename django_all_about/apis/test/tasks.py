...
def check_registration_number_from_hometax(registration_number=1208801280):
    ...
    """
    # payload = f"<map id=\"ATTABZAA001R08\"><pubcUserNo/><mobYn>N</mobYn><inqrTrgtClCd>1</inqrTrgtClCd><txprDscmNo>{registration_number}</txprDscmNo><dongCode>88</dongCode><psbSearch>Y</psbSearch><map id=\"userReqInfoVO\"/></map><nts<nts>nts>30aNOpJQUr8Je6aIwWKR9G3Ml7VdQtMNvTR821IA4fEeE19"
